...
from part_model.models.mask2former.transformer_decoder.position_encoding import (
    PositionEmbeddingSine,
)
from part_model.models.mask2former.transformer_decoder.transformer import (
    TransformerEncoder,
...
class TransformerEncoderPixelDecoder(BasePixelDecoder):
    ...
    def __init__(
        ...
        *,
        ...
        """
        super().__init__(
            input_shape, conv_dim=conv_dim, mask_dim=mask_dim, norm=norm
        )
