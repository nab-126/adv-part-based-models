...
# from part_model.models.mask2former._fpn import build_pixel_decoder
from Mask2Former.mask2former.modeling.pixel_decoder.fpn import (
    build_pixel_decoder,
)
from part_model.models.mask2former.transformer_decoder.maskformer_transformer_decoder import (
    build_transformer_decoder,
)


@SEM_SEG_HEADS_REGISTRY.register()
class CustomMaskFormerHead(nn.Module):
    _version = 2
    ...
    def _load_from_state_dict(
        ...
        if version is None or version < 2:
            ...
            for k in list(state_dict.keys()):
                newk = k
                if "sem_seg_head" in k and not k.startswith(
                    prefix + "predictor"
                ):
